...
class ArxivSearchTool:
    """Arxiv search and paper retrieval tool for multi-agent research system"""
    ...
    def search(self, query: str, max_results: int = 10, sort_by: str = 'relevance') -> Optional[List[Dict]]:
        """
        Search arxiv papers
        ...
        try:
            ...
            logger.error(f"Error parsing arXiv response for '{query}': {e}")
            return None
    
    def search_by_category(self, category: str, query: str = None, max_results: int = 10) -> Optional[List[Dict]]:
        """
    ...
    def search_recent(self, category: str = None, days: int = 7, max_results: int = 10) -> Optional[List[Dict]]:
        """
...
def register_tool(registry):
    """Register arXiv tool in the tool registry"""
    arxiv_tool = ArxivSearchTool()
    
    registry.register('arxiv_search', arxiv_tool.search)
    registry.register('arxiv_search_category', arxiv_tool.search_by_category)
    registry.register('arxiv_search_recent', arxiv_tool.search_recent)
    registry.register('arxiv_get_paper', arxiv_tool.get_paper)
    registry.register('arxiv_get_summary', arxiv_tool.get_summary)
    
    logger.info("Registered arXiv tools: search, search_category, search_recent, get_paper, get_summary")
